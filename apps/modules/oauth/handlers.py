...
class OAuthHandler(WebMessageHandler, OAuthBase):
    ...
    def get(self, provider, action):
        ...
        try:
            ...
            oauth_object = None
            # check our version
            if provider_settings['OAUTH_VERSION'] == '1.0a':
                oauth_object = self.oauth1a_object
            elif provider_settings['OAUTH_VERSION'] == '2.0':
                oauth_object = self.oauth2_object
            else:
