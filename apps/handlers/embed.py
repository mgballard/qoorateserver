...
class EmbedBaseHandler(QoorateBaseHandler):
    ...
    def prepare(self):
        ...
        self.keypair_queryset = KeyPairQueryset(self.application.get_settings('mysql'), db_conn = self.application.db_conn)
        ...
        self.qoorate_queryset = QoorateQueryset(self.application.get_settings('mysql'), db_conn = self.application.db_conn)
